...
function Form_register() {
  ...
  const onSubmit = async (data) => {
    ...
    //   console.log("✅ Usuario registrado:", response.data);
      navigate("/"); // Solo redirige si todo salió bien
    } catch (error) {
      console.error(
    ...
    <div className="form-register">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="position-form-register">
          ...
          <section className="form-register-inputs">
            <div className="mb-3">
              <label htmlFor="firstName" className="form-label labels-form">
                Ingresar Nombres:
              </label>
              <input
                id="firstName"
              ...
              <label htmlFor="lastName" className="form-label labels-form">
                Ingresar Apellidos:
              </label>
              <input
                id="lastName"
              ...
              <label htmlFor="birthDate" className="form-label labels-form">
              ...
              <label htmlFor="gender" className="form-label labels-form">
                Ingresar Genero:
              </label>
              <select
                id="gender"
